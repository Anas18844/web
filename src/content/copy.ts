...
export const home = {
  ...
  audience: {
    title: 'ده مناسب لمين؟',
    intro: 'إحنا مش بنخدم صف واحد. بنخدم أي حد عايز يتعلم البرمجة بعمق حقيقي.',
    items: [
      {
  ...
  system: {
    title: 'بنشتغل إزاي؟',
    intro: 'الخبرة لوحدها مش كفاية — لازم يكون فيه نظام يوصّلها لك.',
    pillars: [
      {
        id: 'session',
        title: 'الشرح',
  ...
  transparency: {
    ...
    body: 'مفيش حد يقدر يضمن لك إنك هتبقى مبرمج محترف في شهر، ولا إن الدرجة مضمونة. اللي أقدر ألتزم بيه قدامك: إن اللي بشرحه ده شغلي الفعلي مش كلام نظري، وإن متابعتك هتبقى بأرقام تشوفها بنفسك، وإني هقولك بصراحة لو مستواك محتاج شغل أكتر بدل ما أطمّنك على الفاضي.',
  },
  ...
  freeTeaser: {
    ...
    body: 'أغلب شغلنا بينزل مجاني بالكامل على اليوتيوب: الحصص والمراجعات وحل الامتحانات والملازم. والمنصة والسنتر اختيار لمين عايز متابعة أقرب — مش شرط عشان تنجح.',
